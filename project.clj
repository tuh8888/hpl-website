(defproject hpl-website "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "hpl-website.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main hpl-website.application
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                :figwheel {:on-jsload "hpl-website.system/reset"}

                :compiler {:main cljs.user
                           :asset-path "js/compiled/out"
                           :output-to "dev-target/public/js/compiled/hpl_website.js"
               ...
               {:id "test"
                ...
                :compiler {:output-to "dev-target/public/js/compiled/testable.js"
                           :main hpl-website.test-runner
                           :optimizations :none}}

               {:id "min"
                :source-paths ["src/cljs" "src/cljc"]
                :jar true
                :compiler {:main hpl-website.system
                           :output-to "resources/public/js/compiled/hpl_website.js"
                           :output-dir "target"
                           :source-map-timestamp true
  ...
  :profiles {:dev
             ...
             {:source-paths ^:replace ["src/clj" "src/cljc"]
              :prep-tasks ["compile"
                           ["cljsbuild" "once" "min"]
                           ["run" "-m" "garden-watcher.main" "hpl-website.styles"]]
              :hooks []
              :omit-source true
              :aot :all}})
